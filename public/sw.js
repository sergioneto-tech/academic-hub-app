...
const SW_VERSION = "1.5.8-controlled-update-11-legacy-save";
...
self.addEventListener("install", (event) => {
  event.waitUntil((async () => {
    ...
    // Hotfix da própria 1.5.8: distribui também o fluxo Gravar no regime anterior
    // sem criar uma nova release funcional nem exigir nova confirmação ao aluno.
