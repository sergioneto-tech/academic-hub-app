...
export default function CloudSyncStatusBadge({ embedded = false }: CloudSyncStatusBadgeProps) {
  ...
  return (
    <div className={`fixed bottom-[8.25rem] left-4 z-50 hidden w-56 items-center justify-center gap-1.5 rounded-xl border bg-sidebar/95 px-3 py-2 text-[11px] font-medium shadow-md backdrop-blur md:inline-flex ${tone}`} role="status" aria-live="polite">
