...
// Revisão técnica da PWA. Pode avançar sem alterar a versão pública quando
// existem correções de cache/Service Worker ou manutenção sem nova release.
export const PWA_REVISION = "1.6.7-transparency-3";
