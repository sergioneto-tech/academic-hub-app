    ...
    <div className="min-h-screen grid place-items-center p-4 bg-gradient-to-b from-slate-50 to-white">
      <Card className="w-full max-w-lg">
        <CardHeader>
          ...
          <CardDescription>
            {loading ? "A verificar sessão…" : user ? `Conta: ${user.email}` : "Abra este ecrã a partir do link enviado para o seu e‑mail."}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {!user ? (
            <div className="text-sm text-muted-foreground space-y-3">
              <p>
                Para alterar a senha, tem de abrir este ecrã através do link enviado para o seu e‑mail.
              </p>
